...
#enter
file_paths = ["txt_files/江苏电信.txt", "txt_files/天津联通.txt", "txt_files/广西电信.txt", "txt_files/Susa.txt"]
...
#enter
file_paths = ["txt_files/四川电信.txt","txt_files/浙江电信.txt", "txt_files/Susaw.txt"]
